function [sp_azimuth_angle_deg_north] = compute_azimuth_angle(sc_pos_x,sc_pos_y,sc_pos_z,sc_vel_x,sc_vel_y,sc_vel_z,phi_Initial_sp_az_orbit)
    ...
    sp_azimuth_angle_deg_north=heading_deg+phi_Initial_sp_az_orbit;
