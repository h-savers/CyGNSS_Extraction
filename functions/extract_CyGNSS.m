...
function [mission,L1b_product,L1b_product_version,timeUTC, ...
        ...
        SP_AZIMUTH_ANGLE, REFLECTIVITY_PEAK, REFLECTIVITY_PEAK_CALIBRATED, QC_2, COHERENCY_RATIO, DDM_LES, PR,PSEUDOSTD,BIT_RATIO,COEFFICIENT_OF_VARIATION,SCALE_FACTOR]= ...
...
%%%%%%%%%%%%%%%%%%%%%
    for jj=sat_index     % loop on  the 8 satellites   
        ...
        if ~isempty(chkfile)    
            ...
            raw_counts,bit_ratio,calibration_table,sampling_seconds,SS_r]=readnc_CyGNSS_v2(inpath,infile,calibration_file,lambda,Doppler_bins,savespace);
